...
type Article struct {
	...
	Description string `xml:"Description,omitempty" json:"digest,omitempty"`    // 图文消息描述
	PicUrl      string `xml:"PicUrl,omitempty"      json:"thumb_url,omitempty"` // 图片链接, 支持JPG, PNG格式, 较好的效果为大图360*200, 小图200*200
